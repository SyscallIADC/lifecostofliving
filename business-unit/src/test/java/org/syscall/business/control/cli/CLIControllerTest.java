...
public class CLIControllerTest {
    ...
    private CLIController createCLIWithInput(String input) {
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        return new CLIController(datamart);
    }

    @Test
    void testMenuExitOption() {
        CLIController cli = createCLIWithInput("4\n");
    ...
    void testAnalyzeCountryValidInput() {
        String input = "1\nEUR\n2000\nSpain\n4\n";
        CLIController cli = createCLIWithInput(input);
        assertDoesNotThrow(cli::startMenu);
    }
